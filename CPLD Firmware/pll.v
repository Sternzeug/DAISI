...
/* Module Version: 5.7 */
/* /usr/local/diamond/3.9_x64/ispfpga/bin/lin64/scuba -w -n pll -lang verilog -synth synplify -arch xo2c00 -type pll -fin 7 -fclkop 126 -fclkop_tol 10.0 -fclkos 42 -fclkos_tol 10.0 -fclkos2 0.0192 -fclkos2_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phases2 0 -phase_cntl STATIC -fb_mode 1 -lock  */
/* Sat Jul  7 17:20:12 2018 */
...
module pll (CLKI, CLKOP, CLKOS, CLKOS2, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    ...
    defparam PLLInst_0.CLKOS3_CPHASE = 104 ;
    defparam PLLInst_0.CLKOS2_FPHASE = 0 ;
    defparam PLLInst_0.CLKOS2_CPHASE = 124 ;
    ...
    defparam PLLInst_0.CLKOS3_DIV = 105 ;
    defparam PLLInst_0.CLKOS2_DIV = 125 ;
    defparam PLLInst_0.CLKOS_DIV = 6 ;
    defparam PLLInst_0.CLKOP_DIV = 2 ;
    defparam PLLInst_0.CLKFB_DIV = 18 ;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOS2="0.019200" */
             /* synthesis FREQUENCY_PIN_CLKOS="42.000000" */
             /* synthesis FREQUENCY_PIN_CLKOP="126.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS2 0.019200
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 42.000000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 126.000000
