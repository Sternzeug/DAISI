...
/* Module Version: 1.2 */
/* /usr/local/diamond/3.9_x64/ispfpga/bin/lin64/scuba -w -n efb -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 126 -spi -spi_mode Both -spi_freq 42 -spi_cs 6 -wb -dev 7000  */
/* Wed Jul 11 21:59:04 2018 */
...
module efb (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, wb_adr_i, 
    ...
    spi_csn)/* synthesis NGD_DRC_MASK=1 */;
    input wire wb_clk_i;
    input wire wb_rst_i;
    input wire wb_cyc_i;
    input wire wb_stb_i;
    ...
    defparam EFBInst_0.SPI_CLK_DIVIDER = 3 ;
    ...
    defparam EFBInst_0.EFB_WB_CLK_FREQ = "126.0" ;
    EFB EFBInst_0 (.WBCLKI(wb_clk_i), .WBRSTI(wb_rst_i), .WBCYCI(wb_cyc_i), 
        ...
        .SPIMOSIEN(spi_mosi_oe), .SPIMCSN7(), .SPIMCSN6(), .SPIMCSN5(spi_csn[5]), 
        .SPIMCSN4(spi_csn[4]), .SPIMCSN3(spi_csn[3]), .SPIMCSN2(spi_csn[2]), 
        .SPIMCSN1(spi_csn[1]), .SPIMCSN0(spi_csn[0]), .SPICSNEN(), .SPIIRQO(), 
