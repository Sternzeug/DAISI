...
/* Module Version: 5.8 */
/* /usr/local/diamond/3.9_x64/ispfpga/bin/lin64/scuba -w -n fifo_buffer -lang verilog -synth synplify -bus_exp 7 -bb -arch xo2c00 -type ebfifo -depth 512 -width 32 -rwidth 32 -no_enable -pe 10 -pf 128  */
...
module fifo_buffer (Data, WrClock, RdClock, WrEn, RdEn, Reset, RPReset, 
    ...
    defparam fifo_buffer_0_1.FULLPOINTER1 = "0b01111111110000" ;
    defparam fifo_buffer_0_1.FULLPOINTER = "0b10000000000000" ;
